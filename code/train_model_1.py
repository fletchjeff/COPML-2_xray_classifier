...
train_file_list = train_file_list + get_file_paths('datalake/data/xray/train/bacteria')
...
train_dataset.colnames = ['normal','pneumonia']
...
test_file_list = test_file_list + get_file_paths('datalake/data/xray/test/bacteria')
...
test_dataset.colnames = ['normal','pneumonia']
